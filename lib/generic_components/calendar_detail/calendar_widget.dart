...
class _CalendarWidgetState extends State<CalendarWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = widget.controller ?? CalendarController.today();
                        ...
                        builder: (_, selectedDate, __) {
                          return Stack(
                            ...
                            children: [
                              ...
                              /// TODO: Buraya şey yapalım abem, date seçtiği zaman monthView kapansın direkt altta dreams gözüksün.
                              ValueListenableBuilder<int>(
                                valueListenable: _monthViewCurrentPage,
  ...
  void _handleDateChanged(DateTime date) {
    ...
    context.read<HomeBloc>().add(SetSelectedDay(selectedDate));
  }
  ...
  void _handleTodayPressed() {
    ...
    var dateToday = DateTime(now.year, now.month, now.day);
    _controller.value = dateToday;
    context.read<HomeBloc>().add(SetSelectedDay(dateToday));
